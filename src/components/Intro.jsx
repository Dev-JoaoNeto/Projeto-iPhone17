  ...
  return (
    <section className="bg-black py-20 px-6"> 
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-16">
            ...
            <button className="border-2 border-white rounded-full hover:bg-white hover:text-black text-white px-8 py-4 text-lg font-medium transition-all duration-300 hover:scale-105 shadow-lg shadow-gray-500/50 cursor-pointer">Saiba mais</button>
        </div>
